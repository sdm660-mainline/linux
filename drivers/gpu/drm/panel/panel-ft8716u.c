...
static int ft8716u_on(struct ft8716u *ctx)
{
	...
	dsi_dcs_write_seq(dsi, 0xff, 0x87, 0x16, 0x01);
	dsi_dcs_write_seq(dsi, 0x00, 0x80);
	dsi_dcs_write_seq(dsi, 0xff, 0x87, 0x16);
	dsi_dcs_write_seq(dsi, 0x00, 0x81);
	dsi_dcs_write_seq(dsi, 0xf3, 0xe8);
	dsi_dcs_write_seq(dsi, 0x00, 0x82);
	dsi_dcs_write_seq(dsi, 0xf3, 0x85);
	dsi_dcs_write_seq(dsi, 0x00, 0x83);
	dsi_dcs_write_seq(dsi, 0xf3, 0xc0);
	dsi_dcs_write_seq(dsi, 0x00, 0x84);
	dsi_dcs_write_seq(dsi, 0xf3, 0xe8);
	dsi_dcs_write_seq(dsi, 0x00, 0x85);
	dsi_dcs_write_seq(dsi, 0xf3, 0x85);
	...
	dsi_dcs_write_seq(dsi, 0xf3, 0x70);
	dsi_dcs_write_seq(dsi, 0x00, 0x89);
	dsi_dcs_write_seq(dsi, 0xf3, 0x00);
	dsi_dcs_write_seq(dsi, 0x00, 0x8a);
	dsi_dcs_write_seq(dsi, 0xf3, 0x00);
	dsi_dcs_write_seq(dsi, 0x00, 0x8b);
	dsi_dcs_write_seq(dsi, 0xf3, 0x70);
	dsi_dcs_write_seq(dsi, 0x00, 0x8c);
	dsi_dcs_write_seq(dsi, 0xf3, 0x00);
	dsi_dcs_write_seq(dsi, 0x00, 0x98);
	dsi_dcs_write_seq(dsi, 0xc5, 0x33);
	dsi_dcs_write_seq(dsi, 0x00, 0x00);
