...
{
	return container_of_const(panel, struct tianma_520_v0, panel);
}
...
static int tianma_520_v0_on(struct tianma_520_v0 *ctx)
{
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd6,
					 0x18, 0x12, 0x0f, 0x11, 0x12, 0x11,
					 0x0f, 0x13, 0x14, 0x16, 0x1b, 0x1b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x00, 0xb0);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd6,
					 0x7e, 0x92, 0x9a, 0x91, 0x76, 0x70,
					 0x7a, 0x7d, 0x6a, 0x7d, 0x6e, 0x81);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x00, 0xc0);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd6,
					 0x6e, 0x81, 0x95, 0x94, 0xc1, 0xcc,
					 0xd1, 0xb7, 0xb8, 0x87, 0x87, 0x72);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x00, 0xd0);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd6,
					 0x6b, 0x96, 0x95, 0x9e, 0x9a, 0x9b,
					 0x8f, 0xa5, 0xaa, 0xaa, 0x80, 0x5c);
...
static const struct drm_display_mode tianma_520_v0_mode = {
	.clock = (1080 + 96 + 2 + 96) * (1920 + 16 + 2 + 16) * 60 / 1000,
	.hdisplay = 1080,
	.hsync_start = 1080 + 96,
	.hsync_end = 1080 + 96 + 2,
	.htotal = 1080 + 96 + 2 + 96,
...
static int tianma_520_v0_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx = devm_drm_panel_alloc(dev, struct tianma_520_v0, panel,
				   &tianma_520_v0_panel_funcs,
...
static const struct of_device_id tianma_520_v0_of_match[] = {
	{ .compatible = "tianma,520-v0" }, // FIXME
	{ /* sentinel */ }
};
